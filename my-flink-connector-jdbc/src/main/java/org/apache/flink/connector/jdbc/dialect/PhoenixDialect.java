...
public class PhoenixDialect extends AbstractDialect {
	...
	public Optional<String> getUpsertStatement(String tableName, String[] fieldNames, String[] uniqueKeyFields) {
		return Optional.of(getUpsertStatement(tableName, fieldNames));
	}

	/**
	 * Get upsert into statement.
	 */
	public String getUpsertStatement(String tableName, String[] fieldNames) {
		...
		return "UPSERT INTO " + quoteIdentifier(tableName) + "(" + columns + ")" + " VALUES (" + placeholders + ")";
	}
	...
	public String getInsertIntoStatement(String tableName, String[] fieldNames) {
		return getUpsertStatement(tableName, fieldNames);
	}
